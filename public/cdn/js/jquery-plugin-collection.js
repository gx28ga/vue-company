...
;(function () {
  var a,
    ...
    F,
    G = [].slice
  ;(q = '<span class="counter-value"></span>'),
    (n =
      '<span class="counter-ribbon"><span class="counter-ribbon-inner">' +
      q +
      '</span></span>'),
    (d =
      '<span class="counter-digit"><span class="counter-digit-spacer">8</span><span class="counter-digit-inner">' +
      n +
      '</span></span>'),
    (g = '<span class="counter-formatting-mark"></span>'),
    (c = '(,ddd).dd'),
    (h = /^\(?([^)]*)\)?(?:(.)(d+))?$/),
    (i = 30),
    (f = 2e3),
              ...
              (function (a) {
                ...
                return (
                  ...
                  (window.jQuery.fn[a] = function (a) {
                    var c
                    return null == a ||
                      null == (null != (c = this[0]) ? c.counter : void 0)
                      ? b.apply(this, arguments)
                      : this[0].counter.update(a)
                  })
                )
              })(a)
            )
    ...
    (m = (function () {
      function a(b) {
        ...
        if (
          ...
          null != this.el.counter)
        )
          return this.el.counter
        ;(this.el.counter = this), (m = a.options)
        for (d in m)
      ...
      return (
        (a.prototype.renderInside = function () {
          return (
            ...
            (this.inside.className = 'counter-inside'),
            (this.el.innerHTML = ''),
                  ...
                  this.el.addEventListener(
                    ...
                    function () {
                      return b
                        ...
                        : ((b = !0),
                          setTimeout(function () {
                            return g.render(), (b = !1), z(g.el, 'counterdone')
                          }, 0),
                          !0)
                    },
                    !1
        ...
        (a.prototype.resetFormat = function () {
          ...
          if (
            ...
            throw new Error('counter: Unparsable digit format')
          return (
            (j = d.slice(1, 4)),
            (g = j[0]),
            (f = j[1]),
        ...
        (a.prototype.render = function (a) {
          ...
          for (
            ...
            (c = b[g]),
              c.length &&
                ((d = /^counter-theme-(.+)$/.exec(c))
                  ? (f = d[1])
                  : /^counter(-|$)/.test(c) || e.push(c))
          return (
            e.push('counter'),
            p || e.push('counter-no-transitions'),
            f ? e.push('counter-theme-' + f) : e.push('counter-auto-theme'),
          ...
          if (((this.digits = []), this.options.formatFunction))
            for (
              ...
              (c = j[f]),
                c.match(/0-9/)
                  ? ((b = this.renderDigit()),
                    (b.querySelector('.counter-value').innerHTML = c),
                    this.digits.push(b),
                    this.insertDigit(b))
                  : this.addSpacer(c)
          else
        ...
        (a.prototype.update = function (a) {
          ...
          return (
            ...
            (b = a - this.value)
              ? (v(
                  this.el,
                  'counter-animating-up counter-animating-down counter-animating'
                ),
                b > 0
                  ? r(this.el, 'counter-animating-up')
                  : r(this.el, 'counter-animating-down'),
                this.stopWatchingMutations(),
                this.animate(a),
                this.startWatchingMutations(),
                setTimeout(function () {
                  return c.el.offsetHeight, r(c.el, 'counter-animating')
                }, 0),
                (this.value = a))
              : void 0
          )
        ...
        (a.prototype.addDigit = function (a, b) {
          var c, d, e, f
          if ((null == b && (b = !0), '-' === a))
            return this.addSpacer(a, null, 'counter-negation-mark')
          if ('.' === a)
          ...
          if (b)
            for (e = !1; ; ) {
              if (!this.format.repeating.length) {
                if (e) throw new Error('Bad counter format without digits')
          ...
          return (
            (d = this.renderDigit()),
            (d.querySelector('.counter-value').innerHTML = a),
            this.digits.push(d),
            this.insertDigit(d)
          )
        }),
            ...
            return (
              ...
              (g = function () {
                ...
                return u() - f > h.options.duration
                  ? ((h.value = a), h.render(), void z(h.el, 'counterdone'))
                  : ((i = u() - e),
                    i > b &&
                      ((e = u()),
            ...
            for (
              ...
              for (
                ...
                (k = l[o]),
                  ...
                  (q.className = 'counter-value'),
                  (q.innerHTML = k),
                  this.ribbons[m].appendChild(q),
                  o === l.length - 1 && r(q, 'counter-last-value'),
                  0 === o && r(q, 'counter-first-value')
            return (
              0 > t && this.addDigit('-'),
              (p = this.inside.querySelector('.counter-radix-mark')),
    ...
    (m.options = null != (E = window.counterOptions) ? E : {}),
    setTimeout(function () {
      var a, b, c, d, e
      if (window.counterOptions) {
        ;(d = window.counterOptions), (e = [])
        for (a in d)
          (b = d[a]),
    ...
    (m.init = function () {
      ...
      if (null != document.querySelectorAll) {
        for (
          b = document.querySelectorAll(m.options.selector || '.counter'),
            f = [],
            c = 0,
            d = b.length;
          d > c;
