        ...
        <div class="row">
          <div class="col-md-8">
            <h2 class="course-title">
              Apache Streaming with Python and PySpark
            </h2>
            <!-- /.course-title -->
            <div class="course-meta">
              ...
              <span class="meta-details">
                ...
                <span class="rating">
                  <input
                    type="hidden"
                    class="rating-tooltip-manual"
                    data-filled="fas fa-star"
                    data-empty="far fa-star"
                    value="4.5"
                    data-fractions="5"
                  />
                  <span>(2,543 Ratings)</span> </span
                ><!-- /.rating -->
              </span>
            </div>
            <img
            ...
            <div class="course-single-details">
              ...
              <div class="tab-content" id="nav-tabContent">
                ...
                >
                  ...
                  <p>
                    <strong>
                      The office assistant wasthe boss’s man,spineless, and with
                      no understanding. What about if he reported sick? But that
                  ...
                  <p>
                    ...
                    answering, it could hardly be recognised as the voice he had
                    had before
                  </p>
                </div>
                <div
                      ...
                      <ul class="content-list">
                        <li>
                          <span class="float-left"
                            ><a href="#"
                              ><i class="far fa-file"></i> Photoshop Interface -
                              just the useful stuff!</a
                            ></span
                          >
                        ...
                        <li>
                          <span class="float-left"
                            ><a href="#"
                              ><i class="fa fa-play-circle"></i> User interface
                              explained</a
                            ></span
                          >
                  ...
                  <div class="author-bio">
                    ...
                    <div class="author-contents media">
                      ...
                      <div class="author-details media-body">
                        ...
                        <p>
                          There was a painful and uncontrollable squeaking mixed
                          in with it, the words could be made out at first but
                          then there was a sort of echo which made them unclear,
                          leaving the hearer unsure whether he had heard
                          properly or not.
                        </p>
                          ...
                          <div class="row">
                            <div class="col-md-5">
                              <div class="media">
                                <img
                                  ...
                                  src="../../assets/comments/1.jpg"
                                  alt="RAvatar"
                                />
                                <div class="author-details media-body">
                                  <span class="time">3 days ago</span>
                                  <h3 class="name">
                                    <a href="#">Cheryl Burns</a>
                                  </h3>
                                  <!-- /.name -->
                                </div>
                                <!-- /.author-details -->
                            ...
                            <div class="col-md-7">
                              <div class="review-details">
                                ...
                                <!-- /.rating -->
                                <p>
                                  Gregor had wanted to give a full answer and
                                  explain everything but in the circumstances
                                  contented himself with saying- I’m getting up
                                  now.
                                </p>
                              </div>
                              <!-- /.review-details -->
                          ...
                          <div class="row">
                            <div class="col-md-5">
                              <div class="media">
                                <img
                                  class="rounded-circle author-avatar"
                                  src="../../assets/comments/2.jpg"
                                  alt="RAvatar"
                                />
                                <div class="author-details media-body">
                                  <span class="time">3 days ago</span>
                                  <h3 class="name">
                                    <a href="#">Bobby Newman</a>
                                  </h3>
                                  <!-- /.name -->
                                </div>
                                <!-- /.author-details -->
                            ...
                            <div class="col-md-7">
                              <div class="review-details">
                                ...
                                <!-- /.rating -->
                                <p>
                                  The change in Gregor’s voice probably could
                                  not be noticed outside through the wooden
                                  door, as his mother was satisfied with this
                                  explanation and shuffled away
                                </p>
                              </div>
                              <!-- /.review-details -->
                            </div>
                          ...
                          <div class="row">
                            <div class="col-md-5">
                              <div class="media">
                                <img
                                  class="rounded-circle author-avatar"
                                  src="../../assets/comments/3.jpg"
                                  alt="RAvatar"
                                />
                                <div class="author-details media-body">
                                  <span class="time">3 days ago</span>
                                  <h3 class="name">
                                    <a href="#">Philip Bell</a>
                                  </h3>
                                  <!-- /.name -->
                                </div>
                                <!-- /.author-details -->
                            ...
                            <div class="col-md-7">
                              <div class="review-details">
                                ...
                                <!-- /.rating -->
                                <p>
                                  But this short conversation made the other
                                  members of the family aware that Gregor,
                                  against their expectations was still at home,
                                  and soon his father came knocking at one of
                                  the side doors gently but with his fist
                                </p>
                              </div>
                              <!-- /.review-details -->
                            </div>
                  ...
                  <div class="col-md-4">
                    <div class="item">
                      ...
                      <div class="item-details">
                        <h3 class="item-title">
                          <a href="course-single-01.html"
                            >HTML5, CSS3, Bootstrap Web Design for Beginners</a
                          >
                        </h3>
                        <!-- /.item-title -->
                        <span class="instructor"
                          ><a href="#">Justin Marks</a></span
                        ><!-- /.instructor -->
                        <div class="details-bottom">
                          <div class="course-price float-left">
                  ...
                  <div class="col-md-4">
                    <div class="item">
                      ...
                      <div class="item-details">
                        <h3 class="item-title">
                          <a href="course-single-01.html"
                            >Learn Your Own Blockchain In JavaScript</a
                          >
                        </h3>
                        <!-- /.item-title -->
                        <span class="instructor"
...
.masthead .header-top .top-contact .close {
  display: none;
}
...
.event-single-contents h1,
.event-single-contents h2,
.event-single-contents h3,
.event-single-contents h4,
.event-single-contents h5,
.event-single-contents h6 {
  color: #37474f;
  margin: 1.935em 0 0.875em;
}
...
.faq .card .card-header button {
  ...
  display: inline-block;
  font-size: 1em;
  padding: 0.935em 2em 1em 1.25em;
  position: relative;
  text-align: left;
  white-space: inherit;
  width: 100%;
...
.instructor-details .meta ul,
.instructor-details .meta ol {
  margin: 0;
  padding: 0;
}
...
.instructor-details .meta ul li:last-child,
.instructor-details .meta ol li:last-child {
  margin-right: 0;
}
.instructor-details .meta ul .meta-id,
.instructor-details .meta ol .meta-id {
  color: #90a4ae;
  display: block;
  font-size: 14px;
  font-weight: 600;
...
.portfolio .item .item-inner:hover:before,
.portfolio .item .item-inner:hover .item-details {
  opacity: 1;
}
